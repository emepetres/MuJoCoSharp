...
namespace BindingGenerator
{
    public static class Helpers
    {
        ...
        private static CSharpCodeProvider cs = new CSharpCodeProvider();
        ...
        {
            if (cs.IsValidIdentifier(name)) { return name; } else { return $"@{name}"; }
        }
